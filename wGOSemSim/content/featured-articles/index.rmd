...
plot_citation_trend('DO5oG40AAAAJ', 'tuHXwOkdijsC')
```

## Disease or Drug analysis

+ [Network and Pathway Analysis of Toxicogenomics Data](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6204403/). **Front Genet**. 2018, 9:484. 
...
+ [Shifting the limits in wheat research and breeding using a fully annotated reference genome](http://science.sciencemag.org/content/361/6403/eaar7191). **Science**. 2018, 361(6403):eaar7191.
...
+ [Quantifying post-transcriptional regulation in the development of Drosophila melanogaster](https://www.nature.com/articles/s41467-018-07455-9). **Nature Communications**. 2018, 9:4970.
...
### small RNA interaction

+ [Inferring Novel Autophagy Regulators Based on Transcription Factors and Non-Coding RNAs Coordinated Regulatory Network](https://www.mdpi.com/2073-4409/7/11/194/htm). __Cell__. 2018, 7(11), 194.

+ [Identification and characterization of ncRNA-associated ceRNA networks in Arabidopsis leaf development](https://doi.org/10.1186/s12864-018-4993-2). __BMC Bioinformatics__. 2018, 19:607.
...
+ [Prediction of Non-coding RNAs as Drug Targets](https://link.springer.com/chapter/10.1007/978-981-13-0719-5_11). **Non-coding RNAs in Complex Diseases**. 2018, 1094:109-115.
